...
학생은 이 장을 끝내면
"브라우저 요청이 어떤 파일을 응답으로 받는지"를 설명할 수 있어야 한다.

---

## 강의 목표

* 정적 파일(static file)의 개념을 이해한다
* Nginx의 root 디렉터리 역할을 이해한다
* 기본 index 파일 동작 방식을 이해한다
* 정적 파일을 직접 수정하고 결과를 확인한다
...
→ [**11. Git을 이용한 서버 프로젝트 관리**](11_git_server_project.md)
